...
exports.handler = async (event, context) => {
    ...
    let result = await pool.request()
      .input('code', sql.NChar(150), body.Code)
      .input('title', sql.NVarChar(150), body.Title)
      .input('value', sql.Float, body.Value)
      .input('status', sql.NVarChar(150), body.Status)
      .input('answer', sql.NVarChar(150), body.Answer)
      ...
      .input('closing_expectation', sql.NVarChar(150), body.Closing_Expectation)
      .input('closed_at', sql.NVarChar(150), body.Closed_At)
      

      .query('INSERT INTO Webhook_FDV (\
        CODE, TITLE, VALUE, STATUS, ANSWER,\
         LOGBOOK_CODE, LOGBOOK_TYPE, LOGBOOK_TEXT, LOGBOOK_CREATED_AT,\
          ...
          CREATED_AT, UPDATED_AT, CLOSING_EXPECTATIONS, CLOSED_AT\
            ...
            @code, @title, @value, @status, @answer,\
             ...
             @step_code, @step_name,\
             @sales_channel_code, @sales_channel_name,\
             @created_at, @updated_at, @closing_expectation, @closed_at)')
